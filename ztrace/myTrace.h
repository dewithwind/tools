...
#define isTrue(x) (!isFalse(x))
#define neq		!=


//↓↓↓↓↓↓↓↓↓↓↓↓↓ 插件data always ↓↓↓↓↓↓↓↓↓↓↓↓↓

#define PLUGIN_NAME "myTrace"
#define PLUGIN_VERSION 1

extern int plugin_hd;
extern HWND main_wnd;

//↓↓↓↓↓↓↓↓↓↓↓↓↓ 插件data user def ↓↓↓↓↓↓↓↓↓↓↓↓↓
enum myMenu
{
	Menu_MAIN_start_trace,
	Menu_MAIN_stop_trace,
	//Menu_DISASM_mytrace,
};
void cb_menu_start_myTrace();
void stop_mytrace();
bool cb_cmd_start_myTrace(int, char **);
